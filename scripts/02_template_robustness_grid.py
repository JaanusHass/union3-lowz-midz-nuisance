...
def fit_cpl_chi2(
    ...
    for start in starts:
        ...
        best = min(best, float(res.fun), float(res2.fun))
    return best
...
def main() -> None:
    ...
    # 3 x 3 x 3 x 1 = 81 variants around the primary template.
    # We vary low-z center, mid-z center, and both widths together.
